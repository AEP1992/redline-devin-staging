...
export default function Dashboard() {
  const { departments, firefighters, allGear, totals, passRate, statusBreakdown, expiredCount } = useData();
  ...
  return (
    <div>
      ...
      <h1 className="text-2xl font-bold text-gray-900 mt-2">{territory}</h1>
      <p className="text-gray-500 text-sm mb-6">{totals.departments} departments · {totals.firefighters.toLocaleString()} personnel · {totals.gear.toLocaleString()} gear items</p>
        ...
        <div className="bg-white rounded-lg border border-surface-border p-5">
          ...
          <div className="space-y-3">
            <UrgentItem
              ...
              label="Expired Gear" count={expiredCount}
            ...
            <UrgentItem
              ...
              label="Out of Service" count={oosCount}
            ...
            <UrgentItem
              ...
              label="Action Required" count={repairCount}
...
function UrgentItem({ icon, label, count, desc, onClick }) {
  return (
    <div className="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 transition-colors cursor-pointer" onClick={onClick}>
