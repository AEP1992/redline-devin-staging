    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden md:flex flex-1 bg-[#1a2a4a] items-center justify-center relative overflow-hidden">
        ...
        <div className="text-center z-10 px-12">
          ...
          <h2 className="text-3xl font-bold text-white mb-3">Hi Devin</h2>
          <p className="text-white/60 text-sm leading-relaxed max-w-md">This is your sandbox portal. Once you give a general spot check, we will migrate your data. The goal here is to eliminate all data problems prior to ingestion — please look at your territories and poke around, and let us know immediately if you see any major issues. Enjoy!</p>
        </div>
      </div>
    </div>
  );
